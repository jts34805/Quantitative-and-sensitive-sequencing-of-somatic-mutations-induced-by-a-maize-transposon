...
do
  	file2="${file:8:-16}" #trim the first 8 and last 16 characters of the file name for the loop. Will be different values depending on the name of the fastq file. 
